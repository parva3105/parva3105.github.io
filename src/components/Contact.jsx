...
export default function Contact() {
  return (
    <Section
      id="contact"
      title="Get in Touch"
      subtitle="Open to software engineering and consulting opportunities."
    >
      <motion.div className={styles.wrap} variants={fadeIn}>
        <p className={styles.heading}>Let's work together</p>
        <p className={styles.subtext}>
          Whether you need a software engineer to build scalable systems or a consultant to drive technical strategy — I'd love to connect.
        </p>
        ...
        <div className={styles.footer}>
          <p>Built with React, Three.js &amp; Framer Motion. Deployed on Vercel.</p>
